...
public class DashboardRoomFormController {
    ...
    public TextField txtFldRoomTypeReg;
    public TextField txtFldQtyReg;
    public TextField txtFldKeyMoneyReg;
    public TextField txtFldTypeSearch;
    public TextField txtFldQtySearch;
    public TextField txtFldSKeyMoneySearch;
